...
# -*- coding: utf-8 -*-
#
# jmolwidgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jmolwidgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jmolwidgetsdoc'
...
latex_documents = [
    (master_doc, 'jmolwidgets.tex', 'jmolwidgets Documentation',
     'Dou Du', 'manual'),
]
